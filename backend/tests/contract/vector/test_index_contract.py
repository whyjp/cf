import numpy as np
import pytest
from cf_backend.adapters.postgres.pool import PostgresPool
from cf_backend.adapters.postgres.camp_repo import PostgresCampWriter
from cf_backend.adapters.pgvector.index import PgvectorIndex
from cf_backend.adapters.numpy_vector.index import NumpyVectorIndex
from cf_backend.domain.models import Camp, Region
