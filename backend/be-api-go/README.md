...
The Go service binds **8073** during the SP-D verification window so it can run side-by-side with the legacy Python `be-api` on 8072 (or 8071 in the current dev launcher). After D-8 cutover the port flips to 8072.
