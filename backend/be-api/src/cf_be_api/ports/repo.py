...
class CampReader(Protocol):
    ...
    def existing_ids_by_source(self, source: str) -> set[str]:
        """Return the set of camp ids in PG with the given source.
        Used by incremental ingest to skip already-persisted records."""
        ...
    def iter_since(self, *, since_iso: str | None = None, ids: list[str] | None = None) -> Iterator[Camp]:
        """Iterate camps with fetched_at > since_iso, OR id IN ids.
        Used by incremental rebuild_graph for partial updates."""
        ...
