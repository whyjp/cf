import numpy as np
from cf_be_api.adapters.cluster.mock import MockClusterer
from cf_be_api.domain.models import Camp, Region, Theme, CampConcept
from cf_be_api.usecases.discover_themes import DiscoverThemes
