...
from cf_be_api.adapters.extract.mock import MockConceptExtractor
from cf_be_api.domain.models import Camp, Region, Concept
from cf_be_api.usecases.extract_desc_signals import ExtractDescSignals
