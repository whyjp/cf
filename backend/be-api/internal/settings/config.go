...
//
// SP-D D-8 cutover (2026-05-11): default port flipped 8073 → 8071. The
// verification window (8073) where Go and Python ran side-by-side is over;
// be-api is now the canonical service on :8071, consumed by be-for-fe.
type Config struct {
	Host        string `envconfig:"BE_API_HOST" default:"127.0.0.1"`
	Port        int    `envconfig:"BE_API_PORT" default:"8071"`
