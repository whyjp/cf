import numpy as np
from camfit_puller.adapters.cluster.mock import MockClusterer
from camfit_puller.domain.models import Camp, Region, Theme, CampConcept
from camfit_puller.usecases.discover_themes import DiscoverThemes
